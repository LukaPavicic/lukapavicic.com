...
import MDSource from '../../md/NiftyRubyFeatures.md'
...
class NiftyRubyFeatures extends React.Component {
        ...
        return (
            <MuiThemeProvider theme={theme}>
                ...
                <Container className={classes.container}>
                    <Typography variant="h2" color="primary">Nifty Ruby and Rails features</Typography>
                    <Typography variant="h5">By <Link href="/">Luka Pavičić</Link> in <Link href="/handbook" style={{color: "#27ae60"}}>Handbook</Link></Typography>
                    <Typography variant="h5" style={{color: "grey"}}>Dec 6 '20</Typography>
...
export default withStyles(useStyles)(NiftyRubyFeatures)