...
import MDSource from '../../md/RailsAPIStarter.md'
...
class RailsAPISetup extends React.Component {
        ...
        return (
            <MuiThemeProvider theme={theme}>
                ...
                <Container className={classes.container}>
                    <Typography variant="h2" color="primary">How to setup Rails for API-only development</Typography>
                    <Typography variant="h5">By <Link href="/">Luka Pavičić</Link> in <Link href="/handbook" style={{color: "#27ae60"}}>Handbook</Link></Typography>
                    <Typography variant="h5" style={{color: "grey"}}>May 25 '20</Typography>
...
export default withStyles(useStyles)(RailsAPISetup)